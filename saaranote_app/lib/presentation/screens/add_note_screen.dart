      ...
      body: Consumer<CreateNoteViewModel>(
        builder: (context, viewModel, child) {
          if (viewModel.isLoading) {
            final loadingText = _generateSummary
          ...
          children: [
            ...
            SwitchListTile(
              ...
              onChanged: (value) => setState(() {
                ...
                if (!value) {
                  _useAiEnhancement = false;
                } else {
                  _useAiEnhancement = true;
                }
              }),
              contentPadding: EdgeInsets.zero,
            ),
            SwitchListTile(
              title: const Text('Use AI Enhancement'),
              subtitle: const Text('Rewrite summary with local AI'),
              value: _useAiEnhancement,
              onChanged: _generateSummary
                  ? (value) => setState(() => _useAiEnhancement = value)
                  : null,
              contentPadding: EdgeInsets.zero,
            ),
            SwitchListTile(
  ...
  Future<void> _saveNote() async {
    ...
    if (_selectedTab == 0) {
      ...
      final success = await viewModel.createNoteFromText(
        ...
        useAiEnhancement: _useAiEnhancement,
